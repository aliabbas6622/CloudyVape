...
import { useAdminLogin, useGetAdminMe, getGetAdminMeQueryKey } from "@/api/hooks";
      ...
      >
        <div className="bg-card border border-border rounded-3xl p-8 shadow-2xl backdrop-blur-xl">
          <div className="flex flex-col items-center text-center mb-8">
            <div className="h-16 w-16 bg-muted border border-border rounded-full flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(97,155,182,0.2)] text-primary">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="pl-10 rounded-xl bg-muted border-border focus-visible:ring-primary focus-visible:border-primary text-foreground h-12 text-lg font-mono"
                  autoFocus
                />
              </div>
            </div>
