...
import { useListCategories } from "@/api/hooks";
      ...
      <div className="container mx-auto px-4 pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            <Link href="/">
              <span className="font-display font-black text-2xl tracking-tighter text-foreground cursor-pointer">
            ...
            <div className="flex gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="h-9 w-9 rounded-full bg-muted flex items-center justify-center text-foreground/60 hover:bg-[#25D366] hover:text-white transition-all shadow-sm"
              >
                <MessageCircle className="h-4.5 w-4.5" />
              </a>
              <a
                href="mailto:s.shayan.ali520@gmail.com"
                className="h-9 w-9 rounded-full bg-muted flex items-center justify-center text-foreground/60 hover:bg-primary hover:text-white transition-all shadow-sm"
              >
